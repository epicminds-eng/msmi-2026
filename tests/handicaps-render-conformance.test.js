...
const pieceList = [
  ...
  { name: 'TEE_PILL_COLORS', text: extract('TEE_PILL_COLORS', /const TEE_PILL_COLORS=\{[\s\S]*?\n\};/) },
  { name: 'teePillStyle', text: extract('teePillStyle', /function teePillStyle\(baseTeeName\)\{[\s\S]*?\n\}/) },
  { name: 'teeMarker', text: extract('teeMarker', /function teeMarker\(label\)\{[\s\S]*?\n\}/) },
  { name: 'teeSwatchHTML', text: extract('teeSwatchHTML', /function teeSwatchHTML\(label\)\{[\s\S]*?\n\}/) },
  { name: 'segHTML', text: extract('segHTML', /function segHTML\(items,activeIdx,attrName,isTee\)\{[\s\S]*?\n\}/) },
